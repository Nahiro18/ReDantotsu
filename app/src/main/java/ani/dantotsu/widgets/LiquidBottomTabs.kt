...
import ani.dantotsu.util.DampedDragAnimation
import ani.dantotsu.util.InteractiveHighlight
                ...
                onDragStopped = {
                    ...
                    animationScope.launch {
                        offsetAnimation.animateTo(
                            0f,
                            spring(dampingRatio = 0.7f, stiffness = 500f, visibilityThreshold = 0.5f)
                        )
                    }
                },
                onDrag = { _, dragAmount ->
